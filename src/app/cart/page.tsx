    ...
    return (
      <div className="pt-24 pb-16 min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="mx-auto h-24 w-24 rounded-3xl bg-zinc-800 flex items-center justify-center mb-6">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div
                key={item.variantId}
                className="card flex gap-4 p-4 transition-all hover:border-zinc-700"
              >
                <div className="relative h-24 w-24 shrink-0 overflow-hidden rounded-xl border border-zinc-800 bg-zinc-800">
                  <Image
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-lg border border-zinc-700 text-zinc-400 hover:border-zinc-600 hover:text-zinc-200 transition-colors"
                      >
          ...
          <div>
            <div className="card p-6 sticky top-24">
              ...
              {totalPrice < 50 && (
                <div className="mt-4 rounded-xl bg-brand-950/40 border border-brand-800/40 p-3 text-xs text-brand-300 text-center">
