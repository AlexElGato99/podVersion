  ...
  return (
    <div className="pt-24 pb-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          <h1 className="text-3xl font-bold text-zinc-100 mb-6">Checkout</h1>
              ...
              <div className="card p-6">
                ...
                <div className="space-y-3 mb-6">
                  {items.map((item) => (
                    ...
                    >
                      <div className="relative h-14 w-14 shrink-0 overflow-hidden rounded-lg border border-zinc-800">
                        <Image
                ...
                <div className="rounded-xl bg-zinc-800/40 p-4 text-sm text-zinc-400 space-y-1.5 mb-6">
                  <p className="font-medium text-zinc-300">Shipping to:</p>
                  <p>
